...
class WeiXin {
     ...
     * @Description: todo(通过openid获得用户信息)
     * @author nipeiquan
     * @param $access_token
     * @param $openid
     * @return  mixed  返回类型
    ...
    public function getUserInfoByOpenid($access_token,$openid){
        ...
        $url = $this->getOauthUrlForUserInfoByOpenid($access_token,$openid);
    ...
    private function getOauthUrlForUserInfoByOpenid($access_token,$openid){
